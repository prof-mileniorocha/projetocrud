...
class App
{
    ...
    {
        define('APP_HOST', $_SERVER['HTTP_HOST'] . "/projetoaula_mvc");
        define('PATH', realpath('./'));
        define('PATH_IMAGENS', "http://" . $_SERVER['HTTP_HOST'] . "/projetoaula_mvc/App/Views/imagens/");
        define('PATH_CSS', "http://" . $_SERVER['HTTP_HOST'] . "/projetoaula_mvc/public/css/");
        define('TITLE', "Projeto Aula");
